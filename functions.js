...
function activate() {
	...
	const fadecover = document.getElementById("cover");
	...
	fadecover.style.visibility = 'hidden';
	fadecover.style.transform = "translate(9999px, -9999px)";
	...
	document.getElementById("videobar").style.zIndex = "1";
}
...
function deactivate() {
	...
	fadeoutGreetings.style.visibility = 'hidden';
	fadeoutGreetings.style.display = 'none';

	fadein.style.opacity = '1';
	fadein.style.visibility = "visible";
	fadecover.style.opacity = '1';
	fadecover.style.visibility = 'visible';
	fadecover.style.transform = "translate(0px, 0px)"
	document.getElementById("videobar").style.zIndex = "-999";
...
function msg() {
	alert("Your response has been noted. Thank you for visiting Floralgia!");
